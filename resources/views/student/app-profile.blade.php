                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="card-profile__info">
                                    <li class="mb-1"><strong class="text-dark mr-4">Phone</strong>
                                        <span>{{$vla->std_phone_num }}</span></li>
                                    <li><strong class="text-dark mr-4">Email</strong> <span>{{$vla->email }}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
