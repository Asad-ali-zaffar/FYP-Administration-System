                                    ...
                                    <form class="form-valide" action="{{$url}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                name="Superviser_Image" value="{{ old('Superviser_Image') }}" accept="image/x-png,image/gif,image/jpeg">
                                                {{-- @if (!empty($valu->image))
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="teacher_dept">Deptartemnt <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <select class="form-control" id="std_session" name="teacher_dept" >
                                                    <option value="">Select Deptartemnt..</option>
                                                    @foreach ($dpt as $val)
