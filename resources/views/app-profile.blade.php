                            ...
                            <div class="card-body">
                                <div class="media align-items-center mb-4">
                                    ...
                                    <div class="media-body">
                                        <h3 class="mb-0">{{$vla->teacher_name}}</h3>
                                ...
                                <ul class="card-profile__info">
                                    <li class="mb-1"><strong class="text-dark mr-4">Gmail</strong>
                                        <span>01793931609</span></li>
                                    <li><strong class="text-dark mr-4">Email</strong> <span>{{$vla->teacher_email}}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
